...
OsDialog(
  ...
  div(class="space-y-4")
    ...
    div(class="space-y-2")
      label(for="hacker-name", class="block text-sm font-medium text-gray-400")
        | Hacker Name
      input(
        id="hacker-name",
        v-model="hackerName",
        ...
        class="w-full rounded-md border border-gray-600 bg-gray-800 px-3 py-2 text-white placeholder-gray-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500",
...
watch(() => gameStateStore.profile.name, (existingName) => {
